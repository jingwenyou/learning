...
class LogUtil(object):
    ...
    def info(self, message):
        ...
        # 同时添加到Allure报告
        allure.attach(formatted_message, name='log', attachment_type=allure.attachment_type.TEXT)
    ...
    def warning(self, message):
        ...
        allure.attach(formatted_message, name='warning_log', attachment_type=allure.attachment_type.TEXT)
